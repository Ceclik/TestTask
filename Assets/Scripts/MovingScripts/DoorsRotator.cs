...
namespace MovingScripts
{
    public class DoorsRotator : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            _rightDoorEndRotation = _rightDoorStartRotation * Quaternion.Euler(0f, 0f, -120.0f); // Противоположное направление
        }
        ...
        private void FixedUpdate()
        {
            if (_isOpening)
            {
                ...
                leftDoor.rotation = Quaternion.Lerp(_leftDoorStartRotation, _leftDoorEndRotation, _elapsedTime / rotationDuration);
                rightDoor.rotation =
